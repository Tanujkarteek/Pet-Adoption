...
List<DataModel> dataList = [
  ...
  DataModel(name: 'Bella', image: 'assets/images/dog3.png', tags: ['dog','young'], age: 6, price: '500', gender:  'Female'),
...
void main() {
  ...
  test('Filter Price should return expected', () async {
    RangeValues testRangeValues = const RangeValues(0,300);
    var output = 3;
    expect(setPrice(testRangeValues,dataList), output);
  });
  test('Filter Age should return expected',() async{
    RangeValues testRangeValues = const RangeValues(0,10);
    var output = 11;
    expect(setAge(testRangeValues,dataList), output);
  });
}